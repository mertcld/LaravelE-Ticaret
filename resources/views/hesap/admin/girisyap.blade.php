                    ...
                    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="user-form-card">
                            <div class="user-form-title">
                                <h2>Admin Paneli Hoşgeldin!</h2>
                                <p>Sistemi yönetmek için lütfen giriş yapınız</p>
                            </div>
                            <form class="user-form" method="post" action="{{route('adminloginpost')}}">
                                @csrf
                                ...
                                <div class="form-button">
                                    ...
                                    <p>Şifreni mi unuttun?<a href="{{route('adminSifreSifirla')}}">Şifreni Sıfırla</a></p>
                                </div>
                            </form>
                        </div>
